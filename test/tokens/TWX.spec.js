...
const TWX = artifacts.require('TWX.sol')
...
contract('TWX', (accounts) => {
  let token
  before(async () => {
    token = await TWX.deployed()
    wait(3)
  })
  ...
  it('should changes owner after transfer', async function () {
    return new Promise(async (resolve, reject) => {
      try {
  ...
  it('should loses owner after renouncement', async function () {
    return new Promise(async (resolve, reject) => {
      try {
